...
Your task is to REDESIGN an existing Shopping Cart page for a headless eCommerce website.

IMPORTANT:
- I already have a working cart system (logic, API, state management)
...
GOAL
----------------------------------
Transform the EXISTING cart page UI into the NEW DESIGN (pixel-perfect match).
