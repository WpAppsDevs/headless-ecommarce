...
export function CategoryGrid() {
  return (
    <section aria-labelledby="purchase-types-heading" className="bg-[#F9F7F3] py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 text-center">
          ...
          <h2 id="purchase-types-heading" className="mt-2 font-serif text-3xl font-bold text-[#0F5132] sm:text-4xl">
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-3 p-5">
                <div className="flex items-center gap-2">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0F5132]/10">
                    <Icon className="h-4 w-4 text-[#0F5132]" />
                  </div>
                  <h3 className="font-serif text-lg font-bold text-[#0F5132]">{label}</h3>
                </div>
                <p className="flex-1 text-sm leading-relaxed text-zinc-500">{description}</p>
                <div className="flex items-center justify-between border-t border-zinc-100 pt-3">
                  <span className="text-xs font-medium text-[#C9A961]">{deliveryNote}</span>
                  <span className="text-xs font-semibold text-[#0F5132] group-hover:underline">
                    Shop Now →
                  </span>
                </div>
              </div>
