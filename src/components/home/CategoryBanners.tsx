  ...
  return (
    <section aria-labelledby="categories-heading" className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 text-center">
        ...
        <h2 id="categories-heading" className="mt-2 font-serif text-3xl font-bold text-[#0F5132] sm:text-4xl">
          ...
          const inner = (
            <div className={`group relative overflow-hidden rounded-2xl ${!b.available ? 'opacity-80' : ''}`}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                {b.available && (
                  <span className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-[#C9A961] group-hover:underline underline-offset-2">
                    {b.cta} →
                  </span>
                )}
              </div>
