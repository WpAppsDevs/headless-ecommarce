        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">Available 7 days a week — order, inquire, or get styling advice</p>
            </div>
          </div>

          {/* Right side */}
          <span className="shrink-0 rounded-full bg-white px-6 py-2.5 text-sm font-semibold text-[#25D366] transition group-hover:bg-white/90">
            Start Chat →
          </span>
        </a>
      </div>
